  ...
  return (
    <div className="min-w-2/12 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="mt-4" ref={dropdownRef} >
            ...
            {openDropdown && (
              <div className="absolute z-10 mt-1 w-2/12 bg-white rounded-md shadow-lg border border-gray-200">
                <ul className="py-1">
                  {workspaces.map((wp) => (
                    <li
                      key={wp}
        ...
        <nav className="mt-4">
          <Link to={"/dashboard"} > <div className="flex items-center px-4 py-2 gap-3 hover:bg-gray-100 rounded mx-1 cursor-pointer">
            <svg className="w-[18px] h-[18px] text-gray-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <span className="text-sm">Home</span>
          </div> </Link>
          <Link to={"/mytasks"} > <div className="flex items-center px-4 py-2 gap-3 hover:bg-gray-100 rounded mx-1 cursor-pointer">
            <svg className="w-[18px] h-[18px] text-gray-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link to={"/settings"} > <div className="flex items-center px-4 py-2 gap-3 hover:bg-gray-100 rounded mx-1 cursor-pointer">
            <svg className="w-[18px] h-[18px] text-gray-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link to={"/members"} > <div className="flex items-center px-4 py-2 gap-3 hover:bg-gray-100 rounded mx-1 cursor-pointer">
            <svg className="w-[18px] h-[18px] text-gray-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
